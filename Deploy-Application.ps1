...
Try {
	...
	[string]$appName = 'Perkins Configuration'
	[string]$appVersion = '1.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0.0'
	[string]$appScriptDate = '05/29/2018'
...
"@
		...
		# This example sets the command prompt as the default shell, and restarts the device if the command prompt is closed.
		    ...
		    $ShellLauncherClass.SetDefaultShell("c:\program files\internet explorer\iexplore.exe -k https://www.unisainc.com/pbweb/", $restart_shell)
		...
		# Set Internet Explorer as the shell for "Cashier", and restart the machine if Internet Explorer is closed.
		    ...
		    #$ShellLauncherClass.SetCustomShell($Cashier_SID, "c:\program files\internet explorer\iexplore.exe -k https://www.unisainc.com/pbweb/", ($null), ($null), $restart_shell)
...
Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\MSUDenver" -Name "PerkinsSet" -Value 'installed' -Type String
